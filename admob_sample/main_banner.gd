...
func _ready():
    ...
    MobileAds.connect("banner_opened", self, "_on_banner_opened")
    MobileAds.connect("banner_clicked", self, "_on_banner_clicked")
    MobileAds.connect("banner_closed", self, "_on_banner_closed")
    MobileAds.connect("banner_recorded_impression", self, "_on_banner_recorded_impression")
    MobileAds.connect("banner_destroyed", self, "_on_banner_destroyed")
